   ...
   <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>&nbsp;&nbsp;&nbsp;L'ESTC en chiffres</h2>
        </div>
        
        <p><ul><li>Effectifs des enseignants permanents : 85</li>
              <li>Effectifs des administratifs : 63</li>
            <li>Effectif des étudiants : 1525</li>
          <li>Nombre de filières : 13 (7 DUT & 5 LP )</li>
        <li>Nombre de départements : 5</li>
      <li>Nombre de laboratoires techniques spécialisés : 21</li>
    <li>Superficie : 3,5 ha</li>
  <li>Nombre des amphithéâtres : 4</li>
<li>Salle des conférences : 1</li>
<li>Nombre Des salles de cours : 36</li>
<li>Salle polyvalante : 1</li>
<li>Terrain de sport : 6 dont 2 gazonnés</li>
<li>Laboratoires de recherche : 4</li></u1></p>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="fa fa-angle-right"></i> <a href="index2.php">Accueil</a></li>
              ...
              <li><i class="fa fa-angle-right"></i> <a href="espace-etu.php">Espace Etudient</a></li>
